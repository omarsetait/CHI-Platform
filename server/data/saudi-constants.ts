...
export const SAUDI_REGIONS = [
  { code: "RIY", nameEn: "Riyadh",          nameAr: "الرياض",          population: 8_600_000, weight: 0.245 },
...
export const TIER1_PROVIDERS: SaudiProvider[] = [
  { id: "PRV-T1-001", nameEn: "King Fahad Medical City",            nameAr: "مدينة الملك فهد الطبية",              city: "Riyadh",  region: "RIY", type: "medical_city",      specialty: "Multi-Specialty",  tier: 1 },
  { id: "PRV-T1-002", nameEn: "King Faisal Specialist Hospital",    nameAr: "مستشفى الملك فيصل التخصصي",          city: "Riyadh",  region: "RIY", type: "specialist_hospital", specialty: "Multi-Specialty", tier: 1 },
  { id: "PRV-T1-003", nameEn: "Al Habib Medical Group",             nameAr: "مجموعة الحبيب الطبية",                city: "Riyadh",  region: "RIY", type: "hospital_group",     specialty: "Multi-Specialty",  tier: 1 },
  { id: "PRV-T1-004", nameEn: "Saudi German Hospital",              nameAr: "المستشفى السعودي الألماني",           city: "Jeddah",  region: "MAK", type: "hospital_group",     specialty: "Multi-Specialty",  tier: 1 },
  { id: "PRV-T1-005", nameEn: "Dallah Hospital",                    nameAr: "مستشفى دلة",                          city: "Riyadh",  region: "RIY", type: "hospital",          specialty: "Multi-Specialty",  tier: 1 },
  ...
  { id: "PRV-T1-008", nameEn: "National Guard Health Affairs",      nameAr: "الشؤون الصحية بالحرس الوطني",         city: "Riyadh",  region: "RIY", type: "government_hospital", specialty: "Multi-Specialty", tier: 1 },
  { id: "PRV-T1-009", nameEn: "King Abdulaziz University Hospital", nameAr: "مستشفى جامعة الملك عبدالعزيز",        city: "Jeddah",  region: "MAK", type: "university_hospital", specialty: "Multi-Specialty", tier: 1 },
  { id: "PRV-T1-010", nameEn: "Almana General Hospital",            nameAr: "مستشفى المانع العام",                  city: "Al Khobar", region: "EST", type: "hospital",        specialty: "Multi-Specialty",  tier: 1 },
  { id: "PRV-T1-011", nameEn: "Al Moosa Specialist Hospital",       nameAr: "مستشفى الموسى التخصصي",               city: "Al Ahsa", region: "EST", type: "specialist_hospital", specialty: "Multi-Specialty", tier: 1 },
  { id: "PRV-T1-012", nameEn: "Habib Medical Group",                nameAr: "مجموعة حبيب الطبية",                  city: "Dammam",  region: "EST", type: "hospital_group",     specialty: "Multi-Specialty",  tier: 1 },
];
...
export const CASE_STUDY_2_PROVIDERS: SaudiProvider[] = [
  { id: "PRV-CS2-001", nameEn: "Al Hayat Women's Hospital", nameAr: "مستشفى الحياة للنساء", city: "Jeddah", region: "MAK", type: "specialist_hospital", specialty: "OB/GYN", tier: 2, riskScore: 79 },
];
...
export const CASE_STUDY_3_PROVIDERS: SaudiProvider[] = [
  { id: "PRV-CS3-001", nameEn: "Eastern Province Medical Center", nameAr: "مركز المنطقة الشرقية الطبي", city: "Dammam", region: "EST", type: "multi_specialty", specialty: "Multi-Specialty", tier: 2, riskScore: 72 },
];
...
export const TIER2_PROVIDERS: SaudiProvider[] = [
  { id: "PRV-T2-001", nameEn: "Al Farabi Dental Center",           nameAr: "مركز الفارابي لطب الأسنان",         city: "Jeddah",     region: "MAK", type: "dental_clinic",      specialty: "Dentistry",       tier: 2 },
  { id: "PRV-T2-002", nameEn: "Al Salama Hospital",                nameAr: "مستشفى السلامة",                    city: "Jeddah",     region: "MAK", type: "hospital",           specialty: "OB/GYN",          tier: 2 },
  { id: "PRV-T2-003", nameEn: "Riyadh Care Hospital",              nameAr: "مستشفى رعاية الرياض",               city: "Riyadh",     region: "RIY", type: "hospital",           specialty: "Multi-Specialty",  tier: 2 },
  { id: "PRV-T2-004", nameEn: "Al Sharq Orthopedic Center",        nameAr: "مركز الشرق لجراحة العظام",          city: "Dammam",     region: "EST", type: "orthopedic_clinic",  specialty: "Orthopedics",     tier: 2 },
  { id: "PRV-T2-005", nameEn: "Magrabi Eye Hospital",              nameAr: "مستشفى مغربي للعيون",               city: "Jeddah",     region: "MAK", type: "ophthalmology_clinic", specialty: "Ophthalmology", tier: 2 },
  { id: "PRV-T2-006", nameEn: "Al Amal Pharmacy Chain",            nameAr: "صيدليات الأمل",                     city: "Riyadh",     region: "RIY", type: "pharmacy",           specialty: "Pharmacy",        tier: 2 },
  { id: "PRV-T2-007", nameEn: "Zahrat Al Rawdah Dental",           nameAr: "زهرة الروضة لطب الأسنان",           city: "Riyadh",     region: "RIY", type: "dental_clinic",      specialty: "Dentistry",       tier: 2 },
  { id: "PRV-T2-008", nameEn: "Abha Private Hospital",             nameAr: "مستشفى أبها الأهلي",                city: "Abha",       region: "ASR", type: "hospital",           specialty: "Multi-Specialty",  tier: 2 },
  { id: "PRV-T2-009", nameEn: "Al Baha Specialist Clinic",         nameAr: "عيادة الباحة التخصصية",             city: "Al Baha",    region: "BAH", type: "multi_specialty",    specialty: "Multi-Specialty",  tier: 2 },
  { id: "PRV-T2-010", nameEn: "Najran General Clinic",             nameAr: "عيادة نجران العامة",                city: "Najran",     region: "NJR", type: "multi_specialty",    specialty: "Multi-Specialty",  tier: 2 },
  { id: "PRV-T2-011", nameEn: "Tabuk Eye Center",                  nameAr: "مركز تبوك للعيون",                  city: "Tabuk",      region: "TBK", type: "ophthalmology_clinic", specialty: "Ophthalmology", tier: 2 },
  { id: "PRV-T2-012", nameEn: "Madinah Women's Clinic",            nameAr: "عيادة المدينة للنساء",              city: "Madinah",    region: "MDN", type: "specialist_hospital", specialty: "OB/GYN",         tier: 2 },
  { id: "PRV-T2-013", nameEn: "Hail Dental Polyclinic",            nameAr: "مجمع حائل لطب الأسنان",             city: "Hail",       region: "HAL", type: "dental_clinic",      specialty: "Dentistry",       tier: 2 },
  { id: "PRV-T2-014", nameEn: "Jazan Orthopedic Center",           nameAr: "مركز جازان لجراحة العظام",          city: "Jazan",      region: "JZN", type: "orthopedic_clinic",  specialty: "Orthopedics",     tier: 2 },
];

// ---------------------------------------------------------------------------
// 8. TIER3_PROVIDERS — 16 small practices
// ---------------------------------------------------------------------------

export const TIER3_PROVIDERS: SaudiProvider[] = [
  { id: "PRV-T3-001", nameEn: "Dr. Al-Otaibi Solo Clinic",      nameAr: "عيادة الدكتور العتيبي",              city: "Riyadh",        region: "RIY", type: "solo_clinic",    specialty: "General Practice",  tier: 3 },
  { id: "PRV-T3-002", nameEn: "Shifa Pharmacy",                 nameAr: "صيدلية الشفاء",                      city: "Riyadh",        region: "RIY", type: "pharmacy",       specialty: "Pharmacy",          tier: 3 },
  { id: "PRV-T3-003", nameEn: "Al Nuzha Family Clinic",         nameAr: "عيادة النزهة العائلية",              city: "Jeddah",        region: "MAK", type: "solo_clinic",    specialty: "Family Medicine",   tier: 3 },
  { id: "PRV-T3-004", nameEn: "Green Crescent Pharmacy",        nameAr: "صيدلية الهلال الأخضر",               city: "Jeddah",        region: "MAK", type: "pharmacy",       specialty: "Pharmacy",          tier: 3 },
  { id: "PRV-T3-005", nameEn: "Al Razi Home Health",            nameAr: "الرازي للرعاية المنزلية",            city: "Dammam",        region: "EST", type: "home_health",    specialty: "Home Health",       tier: 3 },
  { id: "PRV-T3-006", nameEn: "Al Shifaa Solo Practice",        nameAr: "عيادة الشفاء الفردية",               city: "Dammam",        region: "EST", type: "solo_clinic",    specialty: "General Practice",  tier: 3 },
  { id: "PRV-T3-007", nameEn: "Al Dawaa Pharmacy",              nameAr: "صيدلية الدواء",                      city: "Makkah",        region: "MAK", type: "pharmacy",       specialty: "Pharmacy",          tier: 3 },
  { id: "PRV-T3-008", nameEn: "Dr. Al-Zahrani Clinic",          nameAr: "عيادة الدكتور الزهراني",             city: "Abha",          region: "ASR", type: "solo_clinic",    specialty: "General Practice",  tier: 3 },
  { id: "PRV-T3-009", nameEn: "Buraidah Family Practice",       nameAr: "ممارسة بريدة العائلية",              city: "Buraidah",      region: "QSM", type: "solo_clinic",    specialty: "Family Medicine",   tier: 3 },
  { id: "PRV-T3-010", nameEn: "Hayat Home Healthcare",          nameAr: "حياة للرعاية الصحية المنزلية",       city: "Riyadh",        region: "RIY", type: "home_health",    specialty: "Home Health",       tier: 3 },
  { id: "PRV-T3-011", nameEn: "Al Mubarak Pharmacy",            nameAr: "صيدلية المبارك",                     city: "Madinah",       region: "MDN", type: "pharmacy",       specialty: "Pharmacy",          tier: 3 },
  { id: "PRV-T3-012", nameEn: "Dr. Al-Harbi Clinic",            nameAr: "عيادة الدكتور الحربي",               city: "Tabuk",         region: "TBK", type: "solo_clinic",    specialty: "General Practice",  tier: 3 },
  { id: "PRV-T3-013", nameEn: "Arar Medical Dispensary",        nameAr: "مستوصف عرعر الطبي",                  city: "Arar",          region: "NBR", type: "solo_clinic",    specialty: "General Practice",  tier: 3 },
  { id: "PRV-T3-014", nameEn: "Sakaka Family Clinic",           nameAr: "عيادة سكاكا العائلية",               city: "Sakaka",        region: "JOF", type: "solo_clinic",    specialty: "Family Medicine",   tier: 3 },
  { id: "PRV-T3-015", nameEn: "Jazan Community Pharmacy",       nameAr: "صيدلية جازان المجتمعية",             city: "Jazan",         region: "JZN", type: "pharmacy",       specialty: "Pharmacy",          tier: 3 },
  { id: "PRV-T3-016", nameEn: "Najran Home Nursing",            nameAr: "نجران للتمريض المنزلي",              city: "Najran",        region: "NJR", type: "home_health",    specialty: "Home Health",       tier: 3 },
  { id: "PRV-T3-017", nameEn: "Al Kharj Medical Dispensary",    nameAr: "مستوصف الخرج الطبي",                 city: "Al Kharj",      region: "RIY", type: "solo_clinic",    specialty: "General Practice",  tier: 3 },
  { id: "PRV-T3-018", nameEn: "Yanbu Community Pharmacy",       nameAr: "صيدلية ينبع المجتمعية",              city: "Yanbu",         region: "MDN", type: "pharmacy",       specialty: "Pharmacy",          tier: 3 },
  { id: "PRV-T3-019", nameEn: "Khamis Mushait Family Clinic",   nameAr: "عيادة خميس مشيط العائلية",           city: "Khamis Mushait", region: "ASR", type: "solo_clinic",   specialty: "Family Medicine",   tier: 3 },
];
...
export const SAUDI_INSURERS: SaudiInsurer[] = [
  ...
  { id: "INS-002", nameEn: "Tawuniya",               nameAr: "التعاونية",              marketShare: 0.18,  segment: "comprehensive" },
  ...
  { id: "INS-008", nameEn: "ACIG",                   nameAr: "أسيج",                   marketShare: 0.06,  segment: "cooperative" },
  { id: "INS-009", nameEn: "Malath Insurance",       nameAr: "ملاذ للتأمين",            marketShare: 0.05,  segment: "cooperative" },
  { id: "INS-010", nameEn: "Al Rajhi Takaful",       nameAr: "الراجحي تكافل",           marketShare: 0.06,  segment: "takaful" },
];
